...
@implementation JSTFUserTagEditCell
...
- (void)loadComponent{
    ...
    icon.backgroundColor = [UIColor colorWithHex:@"ffffff"];
    [icon.layer setCornerRadius:5*LayoutUtil.scaling];
    ...
    [tagView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(imageView.mas_left).offset(-15*LayoutUtil.scaling);
...
//    [self.tagView.subviews makeObjectsPerformSelector:@selector(removeFromSuperview)];
    ...
    [self.iconView setBackgroundColor:[UIColor colorWithHex:@"ffffff"]];
    self.btnColor = [UIColor colorWithHex:@""];
    self.btnTextColor = [UIColor colorWithHex:@""];
    if (_userInfo) {
        if (_indexPath.section==1) {
            [self.iconView setBackgroundColor:[UIColor colorWithHex:@"247BFF"]];
        ...
        switch (_indexPath.row) {
            case 1:
            {
                [self.iconView setBackgroundColor:[UIColor colorWithHex:@"15AC44"]];
            ...
            case 2:
            {
                [self.iconView setBackgroundColor:[UIColor colorWithHex:@"2157D3"]];
            ...
            case 3:
            {
                [self.iconView setBackgroundColor:[UIColor colorWithHex:@"D87338"]];
            ...
            case 4:
            {
                [self.iconView setBackgroundColor:[UIColor colorWithHex:@"DAB72F"]];
            ...
            case 5:
            {
                [self.iconView setBackgroundColor:[UIColor colorWithHex:@"4239A3"]];
            ...
            case 6:
            {
                [self.iconView setBackgroundColor:[UIColor colorWithHex:@"4390C2"]];
