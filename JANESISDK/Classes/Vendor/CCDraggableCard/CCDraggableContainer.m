    ...
    */
    ...
    if (!disappear) {
        ...
        */
        ...
        //操作对应下标的数据源
        if (self.delegate && [self.delegate respondsToSelector:@selector(draggableContainer:draggableDirection:finishedMoveIndex:)]){
            [self.delegate draggableContainer:self draggableDirection:direction finishedMoveIndex:cardView.tag];
        }
...
- (void)removeForDirection:(CCDraggableDirection)direction {
    ...
    if (self.moving) {
        ...
        [UIView animateWithDuration:0.35 animations:^{
            ...
            //操作对应下标的数据源
            if (self.delegate && [self.delegate respondsToSelector:@selector(draggableContainer:draggableDirection:finishedMoveIndex:)]){
                [self.delegate draggableContainer:self draggableDirection:direction finishedMoveIndex:firstView.tag];
            }
