...
@interface MSThreadSafeMutableArray()
...
@implementation MSThreadSafeMutableArray
#pragma mark - init 方法
- (instancetype)initCommon{
    ...
    if (self) {
        ...
        NSString* uuid = [NSString stringWithFormat:@"%@_%p", NSStringFromClass(self.class),self];
        //注意：_syncQueue是并行队列
